...
import numpy as np
import cv2
image = cv2.imread('RAKESHKVS.jpeg')        #reading the color image
m,n,v = image.shape                                       #know the dimensions of color image.
...
cv2.waitKey(0)
cv2.imshow('Grayscale image + Image with pixels 1/0',gray_image + image_onezeroes2)    #Task3-1
cv2.waitKey(0)
cv2.imshow('Grayscale Image + 20 ',gray_image + 20)  #Task3-2
cv2.waitKey(0)
